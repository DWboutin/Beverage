...
gulp.task('scripts', function(){
  return gulp.src(['./src/assets/js/bootstrap.min.js','./src/assets/js/select2.min.js','./src/assets/js/checkbox.js','./src/assets/js/radio.js','./src/assets/js/bootstrap-switch.js','./src/assets/js/toolbar.js','./src/assets/js/application.js'])
